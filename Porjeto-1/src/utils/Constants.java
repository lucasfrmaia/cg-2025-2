...
public class Constants {
    public static final int WIDTH_MAIN_SCREEN = 1700;
    public static final int HEIGHT_MAIN_SCREEN = 850;
    public static final int WIDTH_CARTESIAN_PLANE = (int) (WIDTH_MAIN_SCREEN * 0.81) - 100;
